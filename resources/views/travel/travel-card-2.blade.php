                ...
                <div class="travel-cards row m-0">
                    ...
                    <a href="#">
                        ...
                        <div class="travel-card__content px-4 py-4">
                            ...
                            <h5 class="travel-card__plan mb-2">Sandhya Prasun Kundu</h5>
                            <div class="d-flex align-items-center">
                                {{-- <i class="fa fa-calendar" style="color:gray"></i> --}}
                                <p class="travel-card__days pl-2 mb-0">Experience of over 15 years with Tulip Software (P) Ltd., Ask Me Information Services, Samtech Engineering Ltd....</p>
                            </div>
